...
DATA=xx_en
data_bin=./PGen/G2T/ASL/data/data_bin/${DATA}

seed=22
EVAL_OUTPUT_PATH=./PGen/G2T/ASL/results/${DATA}_$seed/
CHECKPOINT_DIR=./PGen/G2T/ASL/checkpoints/${DATA}_$seed
...
cp ./PGen/G2T/ASL/data/valid.en $EVAL_OUTPUT_PATH/evaluation/valid.en
cp ./PGen/G2T/ASL/data/valid.xx $EVAL_OUTPUT_PATH/evaluation/valid.xx


#CUDA_VISIBLE_DEVICES=1
CUDA_VISIBLE_DEVICES=1  python train.py $data_bin \
  -s xx -t en \
  --seed $seed \
  --fp16 \
  --encoder-layers 2 \
